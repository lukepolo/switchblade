<div id="jumpsplit-classes" class="jarviswidget jarviswidget-color-blue widget-templates" style="min-width:450px;position: absolute;display: none;">
    ...
    <div role="content">
        ...
        <div class="widget-body">
            ...
            <input id="class_selector" style="width:425px" value="">
        </div>
