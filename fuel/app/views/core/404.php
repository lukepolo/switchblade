        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center error-box">
                    ...
                    <h2 class="font-xl">
                        <strong>
                            <i class="fa fa-fw fa-warning fa-lg text-warning"></i> Page <u>Not</u> Found
                        </strong>
                    </h2>
                    <br>
                    <p class="lead">
                        The page you requested could not be found, either contact your us at <?php echo \Settings::get('helpdesk'); ?> or try again. Use your browsers <b>Back</b> button to navigate to the page you have prevously come from
                    </p>
                    <br>
