...
return array(
	...
	*/
	...
	'cookie'			=> array(
		'cookie_name'		=> 'swbcid',				// name of the session cookie for cookie based sessions
						),

	// specific configuration settings for file based sessions
	'file'				=> array(
		'cookie_name'		=> 'swbfid',				// name of the session cookie for file based sessions
	...
	'memcached'			=> array(
		'cookie_name'		=> 'swbmid',				// name of the session cookie for memcached based sessions
	...
	'db'			=> array(
		'cookie_name'		=> 'swbdid',				// name of the session cookie for database based sessions
	...
	'redis'			=> array(
		'cookie_name'		=> 'swbrid',				// name of the session cookie for redis based sessions
